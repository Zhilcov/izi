...
To open these locks you'll need to use the brute-force method to find the 2-4 long passwords that open the lock.
The Picklock class has to open all three locks and display the results.
